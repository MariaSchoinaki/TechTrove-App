...
| ΠΧ6 | [Αποθήκευση Σύνθεσης](uc6-pc-save.md) | Ο πελάτης θα μπορεί να αποθηκεύει την ολοκληρωμένη σύνθεση του |
| ΠΧ7 | [Αγορά Προϊόντων](uc7-purchase.md) | Ο Πελάτης επιλέγει τις συνθέσεις/ μεμονωμένα εξαρτήματα που θέλει να αγοράσει |
